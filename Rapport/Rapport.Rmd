...
1. le faire décroître linéaire (l'idée étant que plus on se rapproche de la solution, plus les simulations doivent être proches de $x^*$) ;
2. le maintenir constant ;
3. le calculer par maximum de vraisemblance grâce à la formule ci-dessus présentée dans Arrieta (2014).
