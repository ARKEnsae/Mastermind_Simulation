...
Le Joueur 1 choisit obligatoirement une \textbf{permutation} (chaque couleur ne peut apparaître qu’une seule fois, donc $m \leq n$).
...
### Adaptation de l'algorithme précédent (1/2)

Il y a \textbf{deux principaux changements} par rapport à l'algorithme précédent : 
...
### Adaptation de l'algorithme précédent (2/2)
